...
class TvSearchActivity : BaseActivity(), SearchView.OnQueryTextListener,
    ...
    private fun initialiseView() {
        ...
        searchListAdapter = TvSearchListAdapter(this)
    ...
    private fun initialiseViewModel() {
        searchViewModel = ViewModelProviders.of(this, viewModelFactory).get(TvSearchViewModel::class.java)
    }
    ...
    private fun querySearch(text: String) {
        ...
        searchViewModel.getTvListLiveData().observe(this, Observer { resource ->
    ...
    private fun handleSuccessResponse(tvEntities: List<TvEntity>) {
        hideLoader()
        ...
        searchListAdapter.items = tvEntities
        Handler().postDelayed({
